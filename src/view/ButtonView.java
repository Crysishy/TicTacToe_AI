 ...
 * Class: ButtonView.java
 * Description: A GUI which extends JPanel for class TicTacToeGame.java.
 * 				This is the first view of TicTacToeGUI which allows player
 * 				to play Tic Tac Toe with well-organized buttons.
 * 				It is synchronized with the second view - TextAreaView.java 
 */
package view;
