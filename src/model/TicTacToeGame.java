 ...
 * Class: TicTacToeGame.java
 * Description: Main structure for the game Tic Tac Toe.
 * Modifications: 1) Added a new line character between each rows in this.toString.
 * 				  2) Added outOfBound check in this.available.
 */
package model;
